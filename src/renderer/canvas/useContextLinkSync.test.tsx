...
function render(props: LiveContextLinks) { act(() => root.render(<Harness {...props} />)) }
function lastMap() { return setLinks.mock.calls.at(-1)?.[0] as unknown as Record<string, Array<Record<string, unknown>>> }
