...
export interface PtyCreateResult {
   ...
   * (§5 property 4). Remote managed Codex accounts (validation/hooks not wired) and remote
   * system Codex with unresolved home also refuse. Nothing spawned; never use another account.
   */
